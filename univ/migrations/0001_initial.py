    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.CharField(blank=True, max_length=100, verbose_name='로고 URL')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('unique_id', models.CharField(max_length=50, unique=True, verbose_name='기기 ID')),
                ('token', models.CharField(max_length=256, verbose_name='기기 token')),
